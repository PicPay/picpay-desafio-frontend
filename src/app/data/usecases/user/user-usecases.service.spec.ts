...
describe('UserUsecasesService', () => {
  function createSubject({ userRepository = createMockFor(UserRepositoryService) } = {}) {
    userRepository.getAll.mockReturnValue(of(users));
    return {
      subject: new UserUsecasesService(userRepository),
      userRepository,
    };
  }
  ...
  it('should get all users', () => {
    const { subject, userRepository } = createSubject();

    subject.getAllUsers().subscribe(resp => expect(resp).toEqual(users));
